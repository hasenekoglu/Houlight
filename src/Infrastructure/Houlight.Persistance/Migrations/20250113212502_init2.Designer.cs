...
namespace Houlight.Persistence.Migrations
{
    ...
    [Migration("20250113212502_init2")]
    partial class init2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Houlight.Domain.Entities.DriverEntity", b =>
                {
                    ...
                    b.Property<Guid?>("LogisticsCompanyEntityId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("LogisticsCompanyEntityId1");
            ...
            modelBuilder.Entity("Houlight.Domain.Entities.VehicleType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VehicleEntityVehicleType", b =>
                {
            ...
            modelBuilder.Entity("Houlight.Domain.Entities.DriverEntity", b =>
                {
                    ...
                    b.HasOne("Houlight.Domain.Entities.LogisticsCompanyEntity", null)
                        ...
                        .HasForeignKey("LogisticsCompanyEntityId1")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("VehicleEntityVehicleType", b =>
                {
                    ...
                    b.HasOne("Houlight.Domain.Entities.VehicleType", null)
                        .WithMany()
