...
public interface IAuthService
{
    ...
    Task<(bool success, string token)> LoginCustomerAsync(string email, string password);
    Task<(bool success, string token)> LoginCompanyAsync(string email, string password);
